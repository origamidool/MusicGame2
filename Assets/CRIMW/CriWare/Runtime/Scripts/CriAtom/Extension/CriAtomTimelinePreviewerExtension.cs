...
namespace CriWare {
	...
	namespace CriTimeline.Atom {
		...
		/** <summary>
		 * <see cref="CriAtomTimelinePreviewerExtensionBase"/> をAtomMixerBehaviourから呼び出すためのインターフェース<br/>
		 * </summary>
		 */
		internal class CriAtomTimelinePreviewerExtensionManager {
			 ...
			 *   継承したクラスが操作したい型<br/>
			 * Value<br/>
			 *   CriAtomTimelinePreviewerExtensionBaseを継承したオブジェクトをアップキャストしたもの<br/>
			 * </summary>
			 */
			...
			/** <summary>
			 * Atom Timelineを拡張するクラスを更新する<br/>
			 * ProcessFrame()が呼び出し時の、対象Clipの範囲内にいる場合のみ呼び出される<br/>
			 * </summary>
			 * <param name="bindObject"></param>
			 * <param name="trackGuid"></param>
			 * <param name="previewPlayer"></param>
			 */
